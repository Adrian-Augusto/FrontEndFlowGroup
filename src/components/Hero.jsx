...
export function Hero({ searchQuery, onSearchChange }) {
      ...
      <div className="hero__inner">
        <div className="hero__content">
          <h1 id="hero-heading" className="hero__title">
            A nova forma de construir<br />comunidades online
          </h1>
          <p className="hero__text">
            Descubra novos grupos, organize suas comunidades e gerencie tudo em um só lugar.
          </p>

          <div className="hero__search">
            <div className="hero__search-input-wrap">
              <svg className="hero__search-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
              ...
              <input 
                ...
                placeholder="Buscar grupos, temas ou plataformas..."
                value={searchQuery}
                onChange={(e) => onSearchChange(e.target.value)}
              />
            </div>
            <button type="button" className="hero__search-btn" onClick={handleSearchClick}>
              Buscar
            </button>
          </div>
          ...
          <div className="hero__platforms">
            <span className="hero__platform-badge">
